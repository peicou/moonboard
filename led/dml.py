...
# Default-Stop:      0 1 6
# Short-Description: initialize moonboard leds
...
def init_pixels(type=WS2801, npixels = MOONBOARD_PIXELS_COUNT, brightness=BRIGHTNESS):
    driver= WS2801(200, dev='/dev/spidev0.1',spi_interface= SPI_INTERFACES.PERIPHERY,spi_speed=1)
...
def test_leds(pixels, log_func , sleep_func, duration = 10.0, color = COLORS.yellow):
    """"""
...
if __name__=="__main__":
    ...
    parser.add_argument('--type', type=str, default='WS2801',
